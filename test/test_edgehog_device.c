...
TEST_CASE("create an edgehog_device with NULL edgehog_conf", "[edgehog_device]")
{
    edgehog_device_handle_t edgehog_device = edgehog_device_new(NULL);
    TEST_ASSERT(!edgehog_device);
}

TEST_CASE("create an edgehog_device with NULL astarte device in edgehog_conf", "[edgehog_device]")
{
